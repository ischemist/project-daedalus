...
export const THEME_TOKENS = {
  ...
  backgrounds: {
    default: 'bg-white text-popover-foreground dark:bg-zinc-950 dark:text-stone-200',
  ...
  pageHeaderBackgrounds: {
    default: '',
    aegean: 'bg-gradient-to-br from-teal-700/5 to-teal-600/3 dark:from-teal-700/10 dark:to-teal-600/5',
    forge: 'bg-gradient-to-br from-amber-700/5 to-amber-600/3 dark:from-amber-700/10 dark:to-amber-600/5',
    anvil: 'bg-gradient-to-br from-slate-500/8 to-slate-400/4 dark:from-slate-500/12 dark:to-slate-400/6',
  },
  ...
  progressBar: {
    default: { track: 'bg-stone-500/20', indicator: 'bg-stone-600 dark:bg-stone-500' },
    aegean: { track: 'bg-teal-700/20', indicator: 'bg-teal-700 dark:bg-teal-600' },
    forge: { track: 'bg-amber-700/20', indicator: 'bg-amber-700 dark:bg-amber-600' },
    anvil: { track: 'bg-slate-500/20', indicator: 'bg-slate-600 dark:bg-slate-500' },
  },

  // slider range + thumb
  sliders: {
    default: { range: 'bg-stone-600 dark:bg-stone-500', thumb: 'border-stone-600 ring-stone-500/30' },
    aegean: { range: 'bg-teal-700 dark:bg-teal-600', thumb: 'border-teal-700 ring-teal-700/30' },
    forge: { range: 'bg-amber-700 dark:bg-amber-600', thumb: 'border-amber-700 ring-amber-700/30' },
    anvil: { range: 'bg-slate-600 dark:bg-slate-500', thumb: 'border-slate-600 ring-slate-500/30' },
  },
  ...
  dialogs: {
    header: {
      default: '',
      aegean: 'border-b-[1.5px] border-teal-300/30 dark:border-teal-500/35 pb-4 mb-4',
      forge: 'border-b-[1.5px] border-amber-300/30 dark:border-amber-500/35 pb-4 mb-4',
      anvil: 'border-b-[1.5px] border-slate-200/30 dark:border-slate-700/35 pb-4 mb-4',
    },
    title: {
      default: '',
      aegean: 'text-teal-800 dark:text-teal-500',
  ...
  tabs: {
    ...
    trigger: {
      default: {
        hover: 'not-data-active:hover:text-stone-700 dark:not-data-active:hover:text-stone-400',
        focusRing: 'focus-visible:ring-2 focus-visible:ring-stone-500/20 focus-visible:outline-none',
        lineActive: 'group-data-[variant=line]/tabs-list:data-active:text-stone-700 dark:group-data-[variant=line]/tabs-list:data-active:text-stone-400',
        lineUnderline: 'group-data-[variant=line]/tabs-list:data-active:after:bg-stone-500',
        filledActive: 'group-data-[variant=filled]/tabs-list:data-active:bg-stone-500/5 group-data-[variant=filled]/tabs-list:data-active:text-stone-700 dark:group-data-[variant=filled]/tabs-list:data-active:bg-stone-500/10 dark:group-data-[variant=filled]/tabs-list:data-active:text-stone-400',
        filledHover: 'group-data-[variant=filled]/tabs-list:not-data-active:hover:text-stone-700/70 group-data-[variant=filled]/tabs-list:not-data-active:hover:bg-stone-500/5 dark:group-data-[variant=filled]/tabs-list:not-data-active:hover:text-stone-400/70',
        filledText: 'group-data-[variant=filled]/tabs-list:text-stone-700/50 dark:group-data-[variant=filled]/tabs-list:text-stone-400/50',
        defaultActive: 'data-active:bg-background data-active:text-foreground group-data-[variant=default]/tabs-list:data-active:bg-background group-data-[variant=default]/tabs-list:data-active:text-foreground dark:group-data-[variant=default]/tabs-list:data-active:border-input dark:group-data-[variant=default]/tabs-list:data-active:bg-input/30',
      },
      aegean: {
        hover: 'not-data-active:hover:text-teal-800 dark:not-data-active:hover:text-teal-500',
        focusRing: 'focus-visible:ring-2 focus-visible:ring-teal-700/20 focus-visible:outline-none',
        lineActive: 'group-data-[variant=line]/tabs-list:data-active:text-teal-800 dark:group-data-[variant=line]/tabs-list:data-active:text-teal-500',
        lineUnderline: 'group-data-[variant=line]/tabs-list:data-active:after:bg-teal-700',
        filledActive: 'group-data-[variant=filled]/tabs-list:data-active:bg-teal-700/10 group-data-[variant=filled]/tabs-list:data-active:text-teal-800 dark:group-data-[variant=filled]/tabs-list:data-active:bg-teal-700/15 dark:group-data-[variant=filled]/tabs-list:data-active:text-teal-500',
        filledHover: 'group-data-[variant=filled]/tabs-list:not-data-active:hover:text-teal-800/70 group-data-[variant=filled]/tabs-list:not-data-active:hover:bg-teal-700/5 dark:group-data-[variant=filled]/tabs-list:not-data-active:hover:text-teal-500/70',
        filledText: 'group-data-[variant=filled]/tabs-list:text-teal-800/50 dark:group-data-[variant=filled]/tabs-list:text-teal-500/50',
        defaultActive: 'data-active:bg-background data-active:text-teal-800 dark:data-active:text-teal-500 group-data-[variant=default]/tabs-list:data-active:bg-background group-data-[variant=default]/tabs-list:data-active:text-teal-800 dark:group-data-[variant=default]/tabs-list:data-active:text-teal-500 dark:group-data-[variant=default]/tabs-list:data-active:border-teal-700/25 dark:group-data-[variant=default]/tabs-list:data-active:bg-teal-700/5',
      },
      forge: {
        hover: 'not-data-active:hover:text-amber-800 dark:not-data-active:hover:text-amber-500',
        focusRing: 'focus-visible:ring-2 focus-visible:ring-amber-700/20 focus-visible:outline-none',
        lineActive: 'group-data-[variant=line]/tabs-list:data-active:text-amber-800 dark:group-data-[variant=line]/tabs-list:data-active:text-amber-500',
        lineUnderline: 'group-data-[variant=line]/tabs-list:data-active:after:bg-amber-700',
        filledActive: 'group-data-[variant=filled]/tabs-list:data-active:bg-amber-700/10 group-data-[variant=filled]/tabs-list:data-active:text-amber-800 dark:group-data-[variant=filled]/tabs-list:data-active:bg-amber-700/15 dark:group-data-[variant=filled]/tabs-list:data-active:text-amber-500',
        filledHover: 'group-data-[variant=filled]/tabs-list:not-data-active:hover:text-amber-800/70 group-data-[variant=filled]/tabs-list:not-data-active:hover:bg-amber-700/5 dark:group-data-[variant=filled]/tabs-list:not-data-active:hover:text-amber-500/70',
        filledText: 'group-data-[variant=filled]/tabs-list:text-amber-800/50 dark:group-data-[variant=filled]/tabs-list:text-amber-500/50',
        defaultActive: 'data-active:bg-background data-active:text-amber-800 dark:data-active:text-amber-500 group-data-[variant=default]/tabs-list:data-active:bg-background group-data-[variant=default]/tabs-list:data-active:text-amber-800 dark:group-data-[variant=default]/tabs-list:data-active:text-amber-500 dark:group-data-[variant=default]/tabs-list:data-active:border-amber-700/25 dark:group-data-[variant=default]/tabs-list:data-active:bg-amber-700/5',
      },
      anvil: {
        hover: 'not-data-active:hover:text-slate-700 dark:not-data-active:hover:text-slate-400',
        focusRing: 'focus-visible:ring-2 focus-visible:ring-slate-500/20 focus-visible:outline-none',
        lineActive: 'group-data-[variant=line]/tabs-list:data-active:text-slate-700 dark:group-data-[variant=line]/tabs-list:data-active:text-slate-400',
        lineUnderline: 'group-data-[variant=line]/tabs-list:data-active:after:bg-slate-500',
        filledActive: 'group-data-[variant=filled]/tabs-list:data-active:bg-slate-500/10 group-data-[variant=filled]/tabs-list:data-active:text-slate-700 dark:group-data-[variant=filled]/tabs-list:data-active:bg-slate-500/15 dark:group-data-[variant=filled]/tabs-list:data-active:text-slate-400',
        filledHover: 'group-data-[variant=filled]/tabs-list:not-data-active:hover:text-slate-700/70 group-data-[variant=filled]/tabs-list:not-data-active:hover:bg-slate-500/5 dark:group-data-[variant=filled]/tabs-list:not-data-active:hover:text-slate-400/70',
        filledText: 'group-data-[variant=filled]/tabs-list:text-slate-700/50 dark:group-data-[variant=filled]/tabs-list:text-slate-400/50',
        defaultActive: 'data-active:bg-background data-active:text-slate-700 dark:data-active:text-slate-400 group-data-[variant=default]/tabs-list:data-active:bg-background group-data-[variant=default]/tabs-list:data-active:text-slate-700 dark:group-data-[variant=default]/tabs-list:data-active:text-slate-400 dark:group-data-[variant=default]/tabs-list:data-active:border-slate-500/30 dark:group-data-[variant=default]/tabs-list:data-active:bg-slate-500/5',
      },
    },
  },
  ...
  commandIcons: {
    ...
    aegean: "[&_svg:not([class*='text-'])]:text-teal-700/70 dark:[&_svg:not([class*='text-'])]:text-teal-500/70",
    forge: "[&_svg:not([class*='text-'])]:text-amber-700/70 dark:[&_svg:not([class*='text-'])]:text-amber-500/70",
    anvil: "[&_svg:not([class*='text-'])]:text-slate-500/70 dark:[&_svg:not([class*='text-'])]:text-slate-400/70",
  },
  ...
  calendars: {
    default: {
      ...
      focusRing: 'group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-ring/50',
      selected: 'data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground',
      dayRangeStart: 'data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground',
      dayRangeEnd: 'data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground',
      dayRangeMiddle: 'data-[range-middle=true]:bg-muted/50 data-[range-middle=true]:text-foreground',
    },
    aegean: {
      ...
      focusRing: 'group-data-[focused=true]/day:border-teal-500/60 group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-teal-500/30',
      selected: 'data-[selected-single=true]:bg-teal-700 data-[selected-single=true]:text-white dark:data-[selected-single=true]:bg-teal-600',
      dayRangeStart: 'data-[range-start=true]:bg-teal-700 data-[range-start=true]:text-white dark:data-[range-start=true]:bg-teal-600',
      dayRangeEnd: 'data-[range-end=true]:bg-teal-700 data-[range-end=true]:text-white dark:data-[range-end=true]:bg-teal-600',
      dayRangeMiddle: 'data-[range-middle=true]:bg-teal-500/15 data-[range-middle=true]:text-foreground',
    },
    forge: {
      ...
      focusRing: 'group-data-[focused=true]/day:border-amber-500/60 group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-amber-500/30',
      selected: 'data-[selected-single=true]:bg-amber-600 data-[selected-single=true]:text-white',
      dayRangeStart: 'data-[range-start=true]:bg-amber-600 data-[range-start=true]:text-white',
      dayRangeEnd: 'data-[range-end=true]:bg-amber-600 data-[range-end=true]:text-white',
      dayRangeMiddle: 'data-[range-middle=true]:bg-amber-500/15 data-[range-middle=true]:text-foreground',
    },
    anvil: {
      ...
      focusRing: 'group-data-[focused=true]/day:border-slate-500/60 group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-slate-500/30',
      selected: 'data-[selected-single=true]:bg-slate-600 data-[selected-single=true]:text-white dark:data-[selected-single=true]:bg-slate-500',
      dayRangeStart: 'data-[range-start=true]:bg-slate-600 data-[range-start=true]:text-white dark:data-[range-start=true]:bg-slate-500',
      dayRangeEnd: 'data-[range-end=true]:bg-slate-600 data-[range-end=true]:text-white dark:data-[range-end=true]:bg-slate-500',
      dayRangeMiddle: 'data-[range-middle=true]:bg-slate-500/15 data-[range-middle=true]:text-foreground',
    },
  },
  ...
  tooltips: {
    default: {
      content: 'border-stone-300/50 text-stone-700 dark:border-stone-600/55 dark:text-stone-300',
      arrow: 'bg-white dark:bg-zinc-950',
    },
    aegean: {
      content: 'border-teal-500/30 text-teal-800 dark:border-teal-500/55 dark:text-teal-300',
      arrow: 'bg-white dark:bg-zinc-950',
    },
    forge: {
      content: 'border-amber-500/30 text-amber-800 dark:border-amber-500/55 dark:text-amber-300',
      arrow: 'bg-white dark:bg-zinc-950',
    },
    anvil: {
      content: 'border-slate-400/30 text-slate-700 dark:border-slate-500/55 dark:text-slate-300',
      arrow: 'bg-white dark:bg-zinc-950',
    },
  },
} as const
...
export const PAGE_GRADIENT = 'from-background via-background/80 to-background min-h-screen bg-gradient-to-b'
...
export const badges = {
  aegean:
    'bg-teal-100 text-teal-800 dark:bg-teal-900/50 dark:text-teal-400',
  forge:
