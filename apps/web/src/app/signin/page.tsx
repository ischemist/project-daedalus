      ...
      <div className="mx-auto grid min-h-[calc(100svh-5rem)] w-full max-w-6xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="max-w-2xl space-y-5">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-semibold tracking-tight text-balance leading-[1.05] text-teal-700 md:text-5xl dark:text-teal-400">
              retrosynthesis runs on daedalus.
            </h1>
            <p className="text-base leading-8 text-muted-foreground md:text-lg">
              sign in to run any open retrosynthesis planner on a target molecule. we already handled the conda,
              the docker, the queue, and the json.
            </p>
          </div>
        </div>
