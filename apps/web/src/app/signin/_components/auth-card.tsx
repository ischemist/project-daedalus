...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="size-4 shrink-0">
      <path
        fill="#4285f4"
        d="M21.64 12.23c0-.64-.06-1.25-.17-1.84H12v3.48h5.41a4.64 4.64 0 0 1-2 3.05v2.54h3.24c1.9-1.75 2.99-4.33 2.99-7.23Z"
      />
      <path
        fill="#34a853"
        d="M12 22c2.7 0 4.96-.9 6.61-2.44l-3.24-2.54c-.9.6-2.05.96-3.37.96-2.59 0-4.78-1.75-5.56-4.1H3.09v2.62A9.99 9.99 0 0 0 12 22Z"
      />
      <path
        fill="#fbbc04"
        d="M6.44 13.88A5.99 5.99 0 0 1 6.13 12c0-.65.11-1.28.31-1.88V7.5H3.09A9.99 9.99 0 0 0 2 12c0 1.61.38 3.13 1.09 4.5l3.35-2.62Z"
      />
      <path
        fill="#ea4335"
        d="M12 6.02c1.47 0 2.79.5 3.83 1.5l2.87-2.87C16.95 3 14.69 2 12 2A9.99 9.99 0 0 0 3.09 7.5l3.35 2.62c.78-2.35 2.97-4.1 5.56-4.1Z"
      />
    </svg>
  )
}
...
function LastUsedPill() {
  return (
    <span className="absolute top-0 right-3 -translate-y-1/2 rounded-full border border-teal-700/25 bg-white px-2 py-0.5 text-[10px] font-medium tracking-[0.18em] text-teal-700 uppercase dark:border-teal-500/35 dark:bg-zinc-950 dark:text-teal-400">
      last used
    </span>
  )
}
      ...
      <CardContent className="space-y-5 pt-6">
        {hasOauth ? (
          ...
          <p className="rounded-lg border-[1.5px] border-dashed border-teal-700/20 bg-teal-700/4 px-3 py-2 text-xs leading-6 text-muted-foreground dark:border-teal-500/20 dark:bg-teal-500/8">
            github and google oauth will appear here once their provider
            credentials are set.
          </p>
        )}
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[11px] font-medium tracking-[0.24em] text-muted-foreground uppercase">
        ...
        {notice ? (
          <p className="text-sm text-teal-700 dark:text-teal-400">{notice}</p>
        ) : null}
